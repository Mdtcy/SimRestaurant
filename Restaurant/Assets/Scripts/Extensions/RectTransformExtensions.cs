...
namespace TT.Extensions
{
    public static class RectTransformExtensions
    {
        ...
        // public static Vector2 PositionAt(this RectTransform trans,
        //                                  Vector2 ap,
        //                                  CoordinateSystem coordinateSystem = CoordinateSystem.IgnoreAnchorsAndPivot)
        // {
        //     var blPos = trans.GetPosition(coordinateSystem);
        //     var size  = trans.GetSize();
        //     return new Vector2(blPos.x + (ap.x - 0) * size.x,
        //                        blPos.y + (ap.y - 0) * size.y);
        // }
        //
        // public static Vector2 PositionRelativeTo(this RectTransform trans, RectTransform anchorTrans, Vector2 ap)
        // {
        //     var posBlSelf = trans.GetPosition(CoordinateSystem.AsChildOfCanvas);
        //     var posBlObj  = anchorTrans.GetPosition(CoordinateSystem.AsChildOfCanvas);
        //
        //     // 相对anchorTrans左下角的坐标
        //     var posBlRel = posBlSelf - posBlObj;
        //     var size     = trans.GetSize();
        //     return new Vector2(posBlRel.x + (ap.x - 0) * size.x,
        //                        posBlRel.y + (ap.y - 0) * size.y);
        // }
        ...
        //
        // public static void SetPositionRelativeToParent(this RectTransform node,
        //                                                   Vector2 anchor,
        //                                                   Vector2 parentAnchor,
        //                                                   Vector2 offset)
        // {
        //     var size = node.GetSize();
        //     var parentRt = node.parent.rectTransform();
        //     var parentSize = parentRt.GetSize();
        //     node.SetPosition(new Vector2(parentSize.x * parentAnchor.x - size.x * anchor.x + offset.x,
        //                                parentSize.y * parentAnchor.y - size.y * anchor.y + offset.y));
        // }
